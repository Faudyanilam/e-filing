        ...
        <div class="panel-body">
                ...
                <div class="card">
                  ...
                  <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                      ...
                      <div align="right">
                        <button type="button" id="btn_lebih" style="background-color: green; border-radius: 25px; color: white; border: none; height: 30px; width: 100px;" data-toggle="modal" data-target="#exampleModallebih" aria-expanded="false" aria-controls="collapseOne" disabled>Berikutnya <i class="fas fa-chevron-right"></i></button>
                      </div>
          ...
          <div class="card">
            <div class="card-header_c1" id="headingThree" style="border-radius: 7px;">
              <h2 class="mb-0">
                <button class="btn btn-link btn-block text-left collapsed button_1" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" disabled>
          ...
          <div class="card" >
            <div class="card-header_c2" id="headingFour" style="border-radius: 7px">
              <h2 class="mb-0">
                <button class="btn btn-link btn-block text-left collapsed button_1" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour" >
                  <b>D. Pernyataan</b>
                </button>
              </h2>
            </div>
