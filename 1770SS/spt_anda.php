...
// echo $_SESSION['kode_verif_ss'];

$pesan='';
if ($_SERVER["REQUEST_METHOD"] == "POST") {

	if (isset($_POST['kode_verif_1770ss'])) {
		if ($_SESSION['kode_verif_ss']!=$_POST['kode_verif_1770ss']){
			...
			header('location:../berhasil_lapor_ss.php?hasil=berhasil');
...
<div class="container box"> 
	<br />
	<!-- <form method="post" action="../lapor_ss.php" enctype="multipart/form-data">  -->
					...
					<div class="panel-body">
						...
						<div class="card bg-light mb-3" style="width:735px; background-color: white;">
							...
							<div class="card-body card-body_2">  
								...
								<p style="padding-left: 0px; color: rgb(4, 153, 195)"><small>Halaman ke 6 dari 6</small></p><br>
								<!-- end progress bar -->
								...
								<form action="<?php echo $_SERVER["PHP_SELF"]?>" method="post">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6" style="padding-right: 50px">
											...
											<input class="form-control" name="tahun_pajak_ss" id="" value="<?php if (isset($_SESSION['tmptahun_pajak_ss'])) {
									...
									<div class="form-group row">
										...
										<div class="col-sm-6" style="padding-right: 50px">
											<input class="form-control" name="perusahaan" id="perusahaan" value="Nihil" readonly>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6" style="padding-right: 50px">
											<input style="text-align: right;" class="form-control" name="" id="" value="Rp. 0" readonly>
										</div>    
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6" style="padding-right: 50px">
											<input class="form-control" name="kode_verif_1770ss" id="" value="" required disabled>
											<?php echo $pesan; ?>
									...
									<div align="center">
										<!-- <a href="../berhasil_lapor_ss"> -->
											<button type="submit" class="btn btn-secondary" style="background-color: rgb(4, 153, 195); border-radius: 25px; color: white;" data-dismiss="modal" disabled><i class="fas fa-paper-plane"></i> Kirim SPT</button>
											<!-- </a> -->
										</div>
									</form>
									<!-- end form -->
									...
									<div class="form-group row" style="padding-bottom: 	15px">
										...
										<!-- Modal Verifikasi -->
										<form action="proses_kode_verif_ss.php" method="post">
