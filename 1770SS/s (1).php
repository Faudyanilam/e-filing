          ...
          <div class="card bg-light mb-3" style="width:735px; background-color: white;">
                  ...
                  <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                      ...
                      <div align="right">
                        ...
                        <button type="button" id="btn_nihil" style="background-color: #191970; border-radius: 25px; color: white; border: none; height: 30px; width: 100px;" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Berikutnya <i class="fas fa-chevron-right"></i></button></a>
                      </div>
            ...
            <div class="card">
              <div class="card-header_c2" id="headingTwo" style="border-radius: 7px">
                <h2 class="mb-0">
                  <button class="btn btn-link btn-block collapsed button_1" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
