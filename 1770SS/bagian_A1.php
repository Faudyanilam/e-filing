                ...
                <div class="card">
                  ...
                  <div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-sm-6" style="padding-bottom: 10px">
                          ...
                          <button type="button" id="btn_back" style="background-color: rgb(255, 157, 49); border-radius: 25px; color: white; border: none; height: 30px; width: 100px;" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseOne"><i class="fas fa-chevron-left"></i>Sebelumnya</button>
                        </a>
                       </div>
                       <div class="col-sm-6" style="padding-bottom: 10px; padding-left: 250px">
                        <a href="bagian_B.php">
                        <button type="button" id="btn_nihil" style="background-color: rgb(4, 153, 195); border-radius: 25px; color: white; border: none; height: 30px; width: 100px;" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseOne">Selanjutnya <i class="fas fa-chevron-right"></i></button>
                        </a>
                      </div>
                    </div>
                    ...
                    <div align="right">
                        ...
                        <button type="button" id="btn_lebih" data-toggle="modal" data-target="#exampleModallebih" style="background-color: rgb(4, 153, 195); border-radius: 25px; color: white; border: none; height: 30px; width: 100px;" aria-expanded="false" aria-controls="collapseOne">Selanjutnya <i class="fas fa-chevron-right"></i></button>
                   ...
                   <div class="card bg-light mb-3" style="width:700px; background-color: white;">
                    ...
                    <div align="right">
                      <a href="bagian_B.php">
                        <button type="button" id="btn_kurang" style="background-color: rgb(4, 153, 195); border-radius: 25px; color: white; border: none; height: 30px; width: 100px;" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseOne">Selanjutnya <i class="fas fa-chevron-right"></i>
                        </button>
                      </a>
                    </div>
                  </div>
