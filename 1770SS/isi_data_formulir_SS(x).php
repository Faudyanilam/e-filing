...
<body class="bg-body">  
  ...
  <div class="container box"> 
   ...
   <!--  <ul class="nav nav-tabs">
    ...
    <li class="nav-item">
      <a href="layanan_spt.php">Layanan</a>
    </li>
  </ul> -->
  <!-- end membuat tab -->
                ...
                <div class="col-sm-9">
                  <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item grey-nav">
                      <a href="../buat_spt.php" class="font-dark-blue">Buat SPT</a>
                    </li>
              ...
              <div class="card bg-light mb-3 card_5">
                ...
                <div class="card-body card-body_2">  
                  ...
                  <div class="form-group row" style="padding-left: 40px; padding-right: 40px;">
                    ...
                    <div class="col-sm-5">
                      <select name="tahun" id="" class="form-control mb-3" style="max-width: 180px;">
                  ...
                  <div class="form-group row" style="padding-left: 40px; padding-right: 40px">
                    ...
                    <div class="col-sm-5">
                      <input class="form-control" name="perusahaan" id="perusahaan" disabled>
                    </div>
                  </div>
                  <br/>
                  <hr>
                  ...
                  <div style="padding-left: 350px">
                    <a href="bagian_A.php">
                      <button type="button" class="" style="background-color: rgb(4, 153, 195);  border-radius: 25px; color: white; border:none; height: 25px"><small>Selanjutnya</small> <i class="fas fa-chevron-right"></i></button></a>
                    </div>
