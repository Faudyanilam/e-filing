                    ...
                    <div class="form-group row" style="padding-left: 40px; padding-right: 40px;">
                      ...
                      <div class="col-sm-5" id="test">
                        <div class="custom-control custom-radio">
                          <input type="radio" id="normal" value="Normal" name="status_spt_ss" class="custom-control-input" onclick="status();">
                          <label class="custom-control-label" for="ContohRadio1">Normal</label>
                        </div>
                        <div class="custom-control custom-radio">
                          <input type="radio" id="pembetulan" value="Pembetulan" name="status_spt_ss" class="custom-control-input" onclick="status();">
