        ...
        <div class="panel-body">
          ...
          <div class="card bg-light mb-3" style="width:735px; background-color: white;">
            ...
            <div class="card-body card-body_2">  
              ...
              <!-- progress bar -->
              <div class="progress">
                <div class="progress-bar progress-bar-striped" style="width:66.40%; background-color: rgb(255, 157, 49);"><small>66.40%</small></div>
              </div>
              <p class="p_text" style="padding-left: 0px; padding-top: 0px;"><small>Halaman dari ke 4 dari 6</small></p>
              <br/>
        ...
        <!-- <div class="card bg-light mb-3" style="width:700px; background-color: white;">
          <div class="col-sm-6">
            ...
            <div class="col-sm-6" style="padding-left: 240px;">
              <button type="button" class="" data-toggle="modal" data-target="#exampleModal" style="background-color: #191970; border-radius: 25px; color: white; border: none; height: 30px; width: 100px;" disabled><small>Selanjutnya</small><i class="fas fa-chevron-right"></i></button>
            </div>
          </div>
          <br/>
          <br/> -->
