...
<body class="bg-body">  
  ...
  <div class="container box"> 
    ...
    <form method="POST" enctype="multipart/form-data" action="tbl_basic.php">
      ...
      <label>HARGA</label>
      <input type="text" name="harga" class="form-control" value="600.000" readonly>
 
      <label></label>
      <input type="hidden" name="akun" class="form-control" value="pro" readonly>

      <label></label>
      <input type="hidden" name="user" class="form-control" value="64 user" readonly>
      <hr>
...
<?php
  ...
  if($_SESSION['jenis_wp']=='Badan'){
    echo "<meta http-equiv='refresh' content='0;url=spt_badan/lapor.php'>";
  }else{
