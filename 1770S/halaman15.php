						...
						<div class="card bg-light mb-3" style="width:735px; background-color: white;">
							...
							<div class="card-body card-body_2">  
								...
								<table hidden >
									...
									$jumlah_point7 = ($hasil_point5-$hasil_point6);
									...
									$jumlah_8_int= abs($pembayaran_pph25 + $pembayaran_stp_pph25);
									...
									$jumlah_point8 = "Rp. " .$jumlah_point8;
												...
												$jumlah_point9 =$jumlah_8_int-$jumlah_point7;

												$jumlah_point9_rp = number_format($jumlah_point9,0,",",".");

												$jumlah_point9_rp = "Rp. " .$jumlah_point9_rp;
								...
								<form name="form" action="proses_halaman15.php" method="post">
									...
									<div class="form-group row" style="padding-bottom: 	15px">
										<div class="col-sm-7">
											<label name="status_hasil_s">
												...
												if ($hasil_point5 < $hilang6){
													echo "<p class='font-13px' id='penentuan' name='status_hasil'><strong style='color: blue;'>Lebih Bayar</strong></p>";
													echo "<input type='text' name='status_hasil_s' id='status_hasil_s' value='Lebih Bayar' hidden>";
													// $jumlah_point8 = 0;
										...
										<div class="col-sm-5" style=" padding-left: 113px; ">
											<input style="text-align: right;" name="jumlah_hasil_akhir" class="form-control" type="text" value="<?php echo $jumlah_point9_rp;?>" readonly>
										</div>
									</div>
									<!-- end form input --> 
