													...
													<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
														<tr>
															<div class="form-group">
																...
																<td >
																	<input type="text" name="bunga" id="angkaSatu" oninput="hapus()" class="uang form-control" style="text-align: right;" />

																	<input type="text" name="bunga" id="tes" style="text-align: right;" hidden />
														...
														<tr>
															<div class="form-group">
																...
																<td>
																	<input type="text" name="royalti" id="angkaDua" class="uang form-control" style="text-align: right;" oninput="hapus()"/>

																	<input type="text" name="royalti" id="tes2" style="text-align: right;" hidden/>
														...
														<tr>
															<div class="form-group">
																...
																<td>
																	<input type="text" name="sewa" id="angkaTiga" class="uang form-control" style="text-align: right;" oninput="hapus()"/>

																	
																	<input type="text" name="sewa" id="tes3" style="text-align: right;" hidden/>
														...
														<tr>
															<div class="form-group">
																...
																<td>
																	<input type="text" name="hadiah" id="angkaEmpat" class="uang form-control" style="text-align: right;" oninput="hapus()"/>

																	<input type="text" name="hadiah" id="tes4" style="text-align: right;" hidden/>
														...
														<tr>
															<div class="form-group">
																...
																<td>
																	<input type="text" name="keuntungan" id="angkaLima" class="uang form-control" style="text-align: right;" oninput="hapus()"/>

																	<input type="text" name="keuntungan" id="tes5" style="text-align: right;" hidden/>
														...
														<tr>
															<div class="form-group">
																...
																<td>
																	<input type="text" name="p_lain" id="angkaEnam"  class="uang form-control" onkeyup="jumlah();" oninput="hapus()" style="text-align: right;" />

																	<input type="text" name="p_lain" id="tes6"  onkeyup="jumlah();" style="text-align: right;" hidden/>
														...
														<tr>
															<div class="form-group">
																...
																<td>
																	<input type="text" name="jml_a" value="0" id="angkaTujuh" class="uang form-control" style="text-align: right;" oninput="hapus()"readonly />

																	<input type="text" name="jml_a" value="0" id="tes7"  style="text-align: right;" readonly hidden />
