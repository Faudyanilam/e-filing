	...
	<div class="container box"> 
		...
		<form action="halaman18.php">
			...
			<!-- 	<li class="nav-item">
				...
				<li class="nav-item">
					<a hreft="bantuan_spt.php">Bantuan</a>
				</li>
			</ul> -->
						...
						<div class="panel-body">
							...
							<div class="card bg-light mb-3" style="width:735px; background-color: white;">
								...
								<div class="card-body card-body_2">  
									...
									<!-- progress bar -->
									<div class="progress">
										<div class="progress-bar progress-bar-striped" style="width:94.44%; background-color: rgb(255, 157, 49);"><small>94.44%</small></div>
									</div>
									<p style="padding-left: 0px; color: rgb(4, 153, 195)"><small>Halaman ke 17 dari 18</small></p><br/>
									<!-- end progress bar -->

									<!-- setuju -->
									<p class="font-13px" style="color: rgb(4, 153, 195)">Dengan menyadari sepenuhnya akan segala akibatnya termasuk sanksi-sanksi sesuai dengan ketentuan peraturan perundang-undangan yang berlaku saya menyatakan bahwa apa yang telah saya beritahukan di atas adalah benar, lengkap, jelas.</p>
									<div align="center">
										<div class="form-check">
											<input class="form-check-input" type="checkbox" value="" id="defaultCheck1" required />
											<label class="form-check-label font-13px" for="defaultCheck1" style="color: rgb(4, 153, 195)">Setuju/Agree</label>
										</div>
									</div>
									<!-- end setuju -->
									...
									<div class="form-group row" style="padding-bottom: 	15px">
										<div class="col-sm-6">
											...
											<div class="col-sm-6" style="padding-left: 253px;">
												<!-- <a href="halaman18.php"> -->
													<button type="submit" class="" style="background-color: rgb(4, 153, 195); border-radius: 25px; color: white; border: none; height: 30px; width: 100px;"><small>Selanjutnya</small><i class="fas fa-chevron-right"></i></button>
												<!-- </a> -->
												<!-- </div> -->
											</div>
