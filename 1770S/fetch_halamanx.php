...
//fetch_halamanx.php
	...
	if($total_row > 0)
	{
		foreach($result as $row)
		{
			...
			<td width="14%">
			<div align="center">
			<button type="button" name="edit" style="width:24px; height:27px;" class="btn btn-primary btn-xs edit" href="edit_halamanx.php" id="'.$row["id"].'" data-toggle="modal" data-target="#exampleModal2"><i class="fas fa-edit" style="color: white"></i></button>
