 					...
 					<div class="panel-body">
 						...
 						<div class="card bg-light mb-3" style="width:735px; background-color: white;">
 							...
 							<div class="card-body card-body_2">  
 								...
 								<!-- Pertanyaan -->
 								<form name="form" action="proses_halaman6.php" method="post" >
 															...
 															<div class="form-group">
 																...
 																<td >
 																	<div class="input-group">
 																		...
 																		<input type="text" name="sumbangan" id="angkaSatu" onkeyup="jumlah();" oninput="hapus()" value="0" class="uang form-control" style="text-align: right;" />

 																		<input type="text" name="sumbangan" value="0" id="tes" onkeyup="jumlah();" style="text-align: right;" hidden/>
 														...
 														<tr>
 															<div class="form-group">
 																...
 																<td>
 																	<div class="input-group">
 																		<span class="input-group-addon" id="basic-addon1">Rp</span>
 																		<input type="text" name="warisan" id="angkaDua" onkeyup="jumlah();" oninput="hapus()" class="uang form-control"  value="0" style="text-align: right;" />

 																		<input type="text" name="warisan" id="tes2" value="0" onkeyup="jumlah();" style="text-align: right;" hidden/>
 														...
 														<tr>
 															<div class="form-group">
 																...
 																<td>
 																	<div class="input-group">
 																		<span class="input-group-addon" id="basic-addon1">Rp</span>
 																		<input type="text" name="laba_perseroan" id="angkaTiga" onkeyup="jumlah();" oninput="hapus()" value="0" class="uang form-control"   style="text-align: right;"/>

 																		<input type="text" value="0" name="laba_perseroan" id="tes3" style="text-align: right;" onkeyup="jumlah();" hidden/>
 														...
 														<tr>
 															<div class="form-group">
 																...
 																<td>
 																	<div class="input-group">
 																		<span class="input-group-addon" id="basic-addon1">Rp</span>
 																		<input type="text" name="asuransi" id="angkaEmpat" onkeyup="jumlah();" oninput="hapus()" value="0" class="uang form-control"  style="text-align: right;" />

 																		<input type="text" value="0" name="asuransi" id="tes4" style="text-align: right;" onkeyup="jumlah();" hidden/>
 														...
 														<tr>
 															<div class="form-group">
 																...
 																<td>
 																	<div class="input-group">
 																		<span class="input-group-addon" id="basic-addon1">Rp</span>
 																		<input type="text" name="beasiswa" id="angkaLima" onkeyup="jumlah();" oninput="hapus()" value="0" class="uang form-control"   style="text-align: right;"/>

 																		<input type="text" value="0" name="beasiswa" id="tes5" style="text-align: right;" onkeyup="jumlah();" hidden/>
 														...
 														<tr>
 															<div class="form-group">
 																...
 																<td>
 																	<div class="input-group">
 																		<span class="input-group-addon" id="basic-addon1">Rp</span>
 																		<input type="text" name="penghasilan_lain_tob" id="angkaEnam" onkeyup="jumlah();" oninput="hapus()" value="0" class="uang form-control" style="text-align: right;"/>

 																		<input type="text" value="0" name="penghasilan_lain_tob" id="tes6" style="text-align: right;" onkeyup="jumlah();" hidden/>
