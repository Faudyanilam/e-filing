											...
											<span id="ifYes" style="display:none" >
												<div class="form-group row">
													...
													<div class="col-sm-4" id="testing">
														<select class="form-control" name="status_pjk" id="status_pjk" oninput="validasi(this)" oninvalid="validasi(this)" onchange="phmt();" required>
															<option value="" readonly>Pilih</option>
															<option value="tkw">Tidak Kawin</option>
												...
												<div class="form-group row" style="padding-bottom: 	15px">
													...
													<div class="col-sm-4">
														<input type="text" style="width: 215px" value="NPWP" disabled>
													</div>
												</div>
											</span>
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<select class="form-control" name="ptkp" id="ptkp" oninput="validasi(this)" oninvalid="validasi(this)" onchange="phmt()" required>
												...
												<option value="kw">Kawin/K</option>
												<option value="kw_gabung">Kawin Penghasilan istri Di gabung(K/I)</option>
											</select>
										</div>
										<div class="col-sm-2">
