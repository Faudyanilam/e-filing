	...
	<div class="container box"> 
		...
		<div class="tab-content">
					...
					<div class="panel-body">
						...
						<div class="card bg-light mb-3" style="width:735px; background-color: white;">
							...
							<div class="card-body card-body_2">  
								...
								<!-- progress bar -->
								<div class="progress">
									<div class="progress-bar progress-bar-striped" style="width:72.22%; background-color: rgb(255, 157, 49);"><small>72.22%</small></div>
								</div>
								<p style="padding-left: 0px; color: rgb(4, 153, 195)"><small>Halaman ke 13 dari 18</small></p><br>
								<!-- end progress bar -->

								<!-- Pertanyaan -->
								<form action="proses_halaman13.php" method="post">
								<p><b>Apakah Anda memiliki pengembalian/pengurangan PPh Pasal 24 dari penghasilan LN?</b></p>
								<div class="custom-control custom-radio">
									<input type="radio" id="yes" name="memiliki_pengurangan_pph24" class="custom-control-input" onclick="yesnoCheck();" value="Ya">
									<label class="custom-control-label" for="ContohRadio1">Ya</label>
								</div>
								<div class="custom-control custom-radio">
									<input type="radio" id="no" name="memiliki_pengurangan_pph24" class="custom-control-input" onclick="yesnoCheck();" value="0">
									<label class="custom-control-label" for="ContohRadio1">Tidak</label>
								</div>
								<br>
								<!-- end pertanyaan -->

								<!-- input text -->
								<div class="form-group row" style="padding-bottom: 	15px; display: 	none;" id="pengurangan">
									<div class="col-sm-7">
										<p style="color: rgb(4, 153, 195)"><small>Pengembalian/Pengurangan PPh Pasal 24 yang telah dikreditkan</small></p>
									</div>
									<div class="col-sm-5" style="padding-left: 113px; ">
										<input type="text" style=" border: 1px solid rgb(4, 153, 195)" class="form-control" name="pengurangan_pph21" id="pengurangan_pph21" value="0">
									</div>
								</div>
								<!-- end input text -->
			...
			<script type="text/javascript" >
				...
				var pengurangan_pph21 =document.getElementById('pengurangan_pph21');
				pengurangan_pph21.addEventListener('keyup', function(e){
					pengurangan_pph21.value = formatpengurangan_pph21(this.value, 'Rp.');
				});

				function formatpengurangan_pph21(angka, prefix){
				...
				function yesnoCheck() {
					...
					} else document.getElementById('pengurangan').style.display = 'none';
