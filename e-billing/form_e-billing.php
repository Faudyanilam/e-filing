...
<body class="bg-body2" onload="fillCategory();"> 
  ...
  <form action="<?php echo $_SERVER["PHP_SELF"]?>" method="post">
          ...
          <div class="modal-content" style="width: 795px;">
            ...
            <div class="modal-body" style="padding-right: 40px; padding-left: 40px">
              ...
              <div class="form-group row" style="font-size: 16px;">
               ...
               <div class="col-sm-4">
                 <input class="form-control py-3" name="input_kode" id="kodeval" type="text" style="font-size: 16px" readonly />
               </div>
             </div>
             ...
             <div class="col-sm-4">
               <input class="form-control py-3" name="input_kode" id="" type="text" maxlength="6" onkeyup="" style="font-size: 16px" readonly />
             </div>
           </div>
   ...
   <div class="form-group row" style="font-size: 16px;">
    ...
    <div class="col-sm-4">
     <input class="form-control py-3" name="input_kode" id="kodeval" value="gggggggggggggggjhgjhhg" type="text" maxlength="6" style="font-size: 16px" readonly />
   </div>
   <!-- kode billing -->
