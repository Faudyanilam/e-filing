...
<body class="bg-body2" onload="fillCategory();"> 
          ...
          <div class="card-body card-body_2">  
            ...
            <!-- <form action="" method="post"> -->
             <!-- <form name="drop_list" method="post" action="proses_billing.php"> -->
              ...
              <div class="form-group row" align="center" style="font-size: 16px; padding-left: 100px; text-align: right;">
             ...
             <!-- <form name="drop_list"> -->
               <div class="form-group" align="center" style="font-size: 16px; padding-left: 100px; text-align: right;">
                <div class="row">
                ...
                <div class="row">
                  <label class="col-sm-3 col-form-label">Jenis Setoran <font style="color:red; text-align: right;">*</font></label>
                  <div class="col-sm-6">
              ...
              <div class="form-group row" align="center" style="font-size: 16px; padding-left: 100px; text-align: right;" >
                <label class="col-sm-3">Tahun Pajak<font style="color:red;">*</font></label>
                <div class="col-sm-6">
                  <select class="form-control mb-3" name="tahun_pajak" value="" style="font-size: 18px;" required>
                    <placeholder >Tahun
              ...
              <div class="form-group row" align="center" style="font-size: 16px; padding-left: 100px; text-align: right;">
                ...
                ?>
                <div class="col-sm-6">
                  <input class="nop form-control" style="font-size: 18px;" type="text" name="nop" value="" placeholder="00.00.000.000.000-0000.0"/>
                </div>
              </div>

              <div class="form-group row" align="center" style="font-size: 16px; padding-left: 100px; text-align: right;">
                <label class="col-sm-3 col-form-label">Nomor Ketetapan</label>
                <!-- MEMBUAT NOMOR KETETAPAN ACAK -->
                <?php 
                ...
                ?>
                <div class="col-sm-6">
                  <input class="form-control no_ketetapan" style="font-size: 18px;" type="text" id="" name="no_ketetapan" value="" placeholder="00000/000/0000/000">
              ...
              <div class="form-group row" align="center" style="font-size: 16px; padding-left: 100px; text-align: right;">
                ...
                <div class="col-sm-4">
                  <input class="form-control mata-uang" style="font-size: 18px;" type="text" onkeyup="inputTerbilang();" name="jml_setor" id="jml_setor" value="" required/>
                </div>
              </div>
              ...
              <div class="form-group row" align="center" style="font-size: 16px; padding-left: 100px; text-align: right;">
                ...
                <div class="col-sm-6">
                 <textarea class="form-control" style="font-size: 16px;" id="terbilang-output" name="terbilang" readonly value="" required></textarea>
               </div>  
             </div>
             ...
             <div class="form-group row" align="center" style="font-size: 16px; padding-left: 100px; text-align: right;">
              ...
              <div class="col-sm-6">
               <textarea class="form-control" style="font-size: 18px;" name="uraian" placeholder="uraian (75 karakter)"value="" maxlength="75"></textarea>
             </div>
           </div>
           ...
           <div align="center">
            <!-- <a href="halaman2-xxx.php"> -->
              ...
              <a href="form_e-billing.php">
                <input type="button" value="Kosongkan" name="" class="" style="background-color: rgb(178, 34, 33); border-radius: 25px; color: white; border:none; height: 45px; font-size: 16px;"><!-- <small>Selanjutnya</small> <i class="fas fa-chevron-right"></i>/> -->
                </a>
              </div>
  ...
  <!-- </FORM> -->
    ...
    <!-- Modal ringkasan surat-->
    <form action="proses_riwayat.php" method="post">

      <div class="modal fade in" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="width: 1050px">
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content" style="width: 795px;">
            ...
            <div class="modal-body" style="padding-right: 40px; padding-left: 40px">
              ...
              <div class="form-group row" style="font-size: 16px; text-align: right;">
                <label class="col-sm-2 col-form-label">NPWP</label>
                <div class="col-sm-4">
                  <input class="form-control py-3" name="npwp" id="kodeval" type="text" maxlength="6" style="font-size: 16px" value="<?php echo $_SESSION['npwp']; ?>" readonly />
               </div>
               <label class="col-sm-2 col-form-label">NOP</label>
               <div class="col-sm-4">
                 <input class="form-control py-3" name="nop" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpnop'])) {
            ...
            <div class="form-group row" style="font-size: 16px; text-align: right;">
              ...
              <div class="col-sm-4">
               <input class="form-control py-3" name="nama" id="kodeval" type="text" maxlength="6" style="font-size: 16px" value="<?php echo $_SESSION['nama_ktp']; ?>" readonly />
             </div>
             ...
             <div class="col-sm-3">
               <input class="form-control py-3" name="jumlah_setor" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpjml_setor'])) {
          ...
          <div class="form-group row" style="font-size: 16px; text-align: right;">
            ...
            <div class="col-sm-4">
             <textarea class="form-control py-3" name="alamat" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly><?php echo $row['alamat']; ?></textarea>
           </div>
           <label class="col-sm-2 col-form-label">Terbilang</label>
           <div class="col-sm-4">
             <textarea class="form-control py-3" name="terbilang" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value=""><?php if (isset($_SESSION['tmpterbilang'])) {
        ...
        <div class="form-group row" style="font-size: 16px; text-align: right;">
          ...
          <div class="col-sm-4">
           <input class="form-control py-3" name="jenis_pajak" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php 
        ...
        <div class="col-sm-4">
         <textarea class="form-control py-3" name="uraian" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly><?php if (isset($_SESSION['tmpuraian'])) {
  ...
  <div class="form-group row" style="font-size: 16px; text-align: right;">
    ...
    <div class="col-sm-4">
     <input class="form-control py-3" name="jenis_setoran" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpjenis_setoran'])) {
  ...
  <div class="col-sm-4">
   <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php echo $_SESSION['npwp']; ?>"/>
 </div>
</div>
...
<div class="form-group row" style="font-size: 16px; text-align: right;">
  ...
  <div class="col-sm-4">
   <input class="form-control py-3" name="masa_pajak" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpmasa_pajak_sebelum'])) {
...
<div class="col-sm-4">
 <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="
 <?php echo $_SESSION['nama_ktp']; ?>"/>
</div>
</div>
...
<div class="form-group row" style="font-size: 16px; text-align: right;">
  ...
  <div class="col-sm-4">
   <input class="form-control py-3" name="tahun_pajak" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmptahun_pajak'])) {
...
?>
<div class="col-sm-4">
 <input class="form-control py-3 kode_bil" name="kode_billing" id="kodeval" type="text" value="<?php echo getToken(15); ?>" style="font-size: 16px" readonly />
...
<div class="form-group row" style="font-size: 16px; text-align: right;">
  ...
  <div class="col-sm-4">
   <input class="form-control py-3" name="no_sk" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpno_ketetapan'])) {
...
<div class="col-sm-4">
 <?php
 $time_sekarang = time();
 $tes = date("d/m/Y", strtotime("+30 days", $time_sekarang));
 $tes2 = $tes . date(" H:i:s");
 ?>
 <input class="form-control py-3" name="masa_aktif" id="kodeval" type="text" value="<?php echo $tes2; ?>" style="font-size: 16px" readonly />
</div>
</div>
</div>
<!-- end modal body -->
...
<div class="modal-footer" style="padding-right: 40px">
  ...
  <a href="cetak_pdf.php">
    <input type="submit" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal2" name="submit" id="submit" value="Cetak" style="border-radius: 25px; background-color: rgb(4, 153, 195); font-size: 16px"/>
  </a>
</div>
</div>
<!-- end modal content -->
...
<!-- JQUERY KODE BILLING, NO. KETETAPAN-->
<script type="text/javascript">

      $(document).ready(function(){
        // format mata uang
        $( '.kode_bil' ).mask('0000 0000 0000 000', {reverse: true});

        // format no. ketetapan
        $( '.no_ketetapan' ).mask('00000/000/00/000/00', {reverse: false});

        // format NOP
        $( '.nop' ).mask('00.00.000.000.000-0000.0', {reverse: false});
      });
    </script>
  </body>
  </html>
