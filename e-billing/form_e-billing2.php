  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['input_kode'])) {
      if ($_SESSION['kode_captcha']!=$_POST['input_kode']){
        ...
        <script>
          window.location.href = "form_e-billing3.php";
        </script>
  ...
  <form action="<?php echo $_SERVER["PHP_SELF"]?>" method="post">
        ...
        <!-- <form action="" method="post"> -->
          <div class="modal-content">
           ...
           <div class="modal-footer">
            ...
            <!-- <a href="form_e-billing.php"> -->
              <input type="submit" class="btn btn-primary btn-sm"  name="submit" id="submit" value="Submit" style="border-radius: 25px; background-color: rgb(4, 153, 195); font-size: 16px"/>
              <!-- </a> -->
            </div>
    ...
    <div class="modal fade in" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="width: 1050px">
      ...
      <div class="modal-dialog">
        ...
        <div class="col-sm-4">
         <textarea class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly/><?php if (isset($_SESSION['tmpjenis_pajak'])) {
          $tmpjenis_pajak= $_SESSION['tmpjenis_pajak'];
        }


        echo end($tmpjenis_pajak);
        $jenis_pajak = end($tmpjenis_pajak); ?></textarea>
      </div>
    </div>
