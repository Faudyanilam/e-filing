...
if($cek == 1){
	...
	if($row['id_paket'] == null){
		if($row['jenis_wp'] == "Orang Pribadi"){ //mengecek jenis wajib pajak apakah Badan atau Orang Pribadi
			// HARI INI
			...
			header('location:lapor.php?hasil1=berhasil');
		}else{
			header('location:login.php?hasil1=gagal2');
			session_destroy();
		}
	...
	header('location:login.php?hasil1=gagal');
}
?>
