             ...
             <!-- <form name="drop_list"> -->
               <div class="form-group" align="center" style="font-size: 16px; padding-left: 100px;">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <SELECT  class="form-control" id="Category" NAME="jenis_pajak" style="font-size: 16px;" onChange="SelectSubCat();" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <select class="form-control" id="SubCat" name="jenis_setoran" style="font-size: 16px;" onchange="showUser(this.value);showUserMobile(this.value);">
                        <option value="">Pilih...</option>
                      </select>
                    </div>
                  </div>
...
<!--      <div name="drop_list" id="drop_list" class="form-group" align="center" style="font-size: 16px" >
                <div class="row">
                <label class="col-sm-3 col-form-label">Jenis Pajak <font style="color:red">*</font></label>
                <div class="col-sm-5">
                  <select class="form-control mb-3" id="Category" NAME="Category" onChange="SelectSubCat();" style="font-size: 18px;" value="">
                    <placeholder>Pilih...
                    <option selected="selected" value="0" required>Pilih...</option>
                  </placeholder>
                  </select>
                </div>
              </div>
             ...
             <!--  <div class="form-group row" align="center" style="font-size: 16px" >
                <label class="col-sm-3 col-form-label">Jenis Pajak <font style="color:red">*</font></label>
                <div class="col-sm-5">
                  <select class="form-control mb-3" style="font-size: 18px;" name="jenis_pajak" value="">
                    <placeholder>Pilih...
                    <option selected="selected" value="" required>Pilih...</option>
                    <option selected="selected" value="411111">411111-PPh Minyak Bumi</option>
                    <option selected="selected" value="411112">411112-PPh Gas Alam</option>
                    <option selected="selected" value="411121">411121-PPh Pasal 21</option>
                    <option selected="selected" value="411122">411122-PPh Pasal 22</option>
                    <option selected="selected" value="411123">411123-PPh Pasal 22 Impor</option>
                    <option selected="selected" value="411124">411124-PPh Pasal 23</option>
                    <option selected="selected" value="411125">411125-PPh Psl 25 Orang Pribadi</option>
                    <option selected="selected" value="411127">411127-PPh Pasal 26</option>
                    <option selected="selected" value="411128">411128-PPh Final</option>
                    <option selected="selected" value="411129">411129-PPh Non-Migas Lainnya</option>
                    <option selected="selected" value="411211">411211-PPN Dalam Negeri</option>
                    <option selected="selected" value="411212">411212-PPN Impor</option>
                    <option selected="selected" value="411219">411219-PPN Lainnya</option>
                    <option selected="selected" value="411221">411221-PPn BM Dalam Negeri</option>
                    <option selected="selected" value="411222">411222-PPn BM Impor</option>
                    <option selected="selected" value="411229">411229-PPn BM Lainnya</option>
                    <option selected="selected" value="411313">411313-PBB Perkebunan</option>
                    <option selected="selected" value="411314">411314-PBB Perhutanan</option>
                    <option selected="selected" value="411315">411315-PBB Pertambangan Minerba</option>
                    <option selected="selected" value="411316">411316-PBB Pertambangan Migas</option>
                    <option selected="selected" value="411317">411317-PBB Pertambangan Pabum</option>
                    <option selected="selected" value="411319">411319-PBB Sektor Lainnya</option>
                    <option selected="selected" value="411611">411611-Bea Meterai</option>
                    <option selected="selected" value="411612">411612-PPn Benda Meterai</option>
                    <option selected="selected" value="411619">411619-Pajak Tdk Langsung Lainnya</option>
                    <option selected="selected" value="411621">411621-Bunga/Denda Penagihan PPh</option>
                    <option selected="selected" value="411622">411622-Bunga/Denda Penagihan PPN</option>
                    <option selected="selected" value="411623">411623-Bunga/Denda Penagihan PPnBM</option>
                    <option selected="selected" value="411624">411624-Bunga/Denda Penagihan PTLL</option>
                  </placeholder>
                  </select>
                </div>
              </div> -->
              ...
              <div class="form-group row" align="center" style="font-size: 16px; padding-left: 100px;">
                ...
                <div class="col-sm-2">
                  <input class="form-control" style="font-size: 16px;" type="" name="" value="IDR (Rp)" readonly>
                </div>
                <div class="col-sm-4">
           ...
           <div align="center">
            <!-- <a href="halaman2-xxx.php"> -->
              <input type="submit" value="Buat Kode Billing" data-toggle="modal" data-target="#exampleModal" name="submit" class="" style="background-color: rgb(4, 153, 195); border-radius: 25px; color: white; border:none; height: 45px; font-size: 16px;"><!-- <small>Selanjutnya</small> <i class="fas fa-chevron-right"></i>/> -->
              <!-- </a> -->
              <!-- <a href="halaman2-xxx.php"> -->
  ...
  <!-- Modal kode keamanan -->
  <div class="modal fade in" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" role="dialog" style="display:block;">
      ...
      <div class="modal-dialog">
        ...
        <!-- <form action="" method="post"> -->
          <div class="modal-content" style="width: 795px;">
            ...
            <div class="modal-body" style="padding-right: 40px; padding-left: 40px">
              ...
              <div class="form-group row" style="font-size: 16px;">
               ...
               <div class="col-sm-4">
                 <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpnop'])) {
            ...
            <div class="form-group row" style="font-size: 16px;">
             ...
             <div class="col-sm-4">
               <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpjml_setor'])) {
          ...
          <div class="form-group row" style="font-size: 16px;">
           ...
           <div class="col-sm-4">
             <textarea class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpterbilang'])) {
              $tmpterbilang = $_SESSION['tmpterbilang'];
            }

            echo end($tmpterbilang);
            $terbilang = end($tmpterbilang); ?>"> </textarea>
          </div>
        </div>
        ...
        <div class="form-group row" style="font-size: 16px;">
          ...
          <div class="col-sm-4">
           <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php 
        ...
        <div class="col-sm-4">
         <textarea class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly/><?php if (isset($_SESSION['tmpuraian'])) {
          $tmpuraian= $_SESSION['tmpuraian'];
        }


        echo end($tmpuraian);
        $uraian = end($tmpuraian); ?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row" style="font-size: 16px;">
      ...
      <div class="col-sm-4">
       <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpjenis_setoran'])) {
 ...
 <div class="form-group row" style="font-size: 16px;">
  ...
  <div class="col-sm-4">
   <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpmasa_pajak_sebelum'])) {
...
<div class="form-group row" style="font-size: 16px;">
  ...
  <div class="col-sm-4">
   <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmptahun_pajak'])) {
...
<div class="form-group row" style="font-size: 16px;">
  ...
  <div class="col-sm-4">
   <input class="form-control py-3" name="input_kode" id="kodeval" type="text" maxlength="6" style="font-size: 16px" readonly value="<?php if (isset($_SESSION['tmpno_ketetapan'])) {
