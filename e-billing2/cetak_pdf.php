																			...
																			<td valign="top">
																				<div class="client_info">
																					<table border="0" cellpadding="0" cellspacing="0">
																						<tbody>
																							<tr>
																								<td style="padding-left:25px;">: <?php echo $nama; ?><span class="editable-area" id="client_info"><br />
																								</tr>
																							</tbody>
																						</table>
																					</div>
																				...
																				<td valign="top">
																					<div class="client_info">
																						<table border="0" cellpadding="0" cellspacing="0">
																							<tbody>
																								<tr>
																									<td style="padding-left:25px;">: <?php if (isset($_SESSION['tmpjml_setor'])) {
																					...
																					<td valign="top">
																						<div class="client_info">
																							<table border="0" cellpadding="0" cellspacing="0">
																								<tbody>
																									<tr>
																										<td style="padding-left:75px; white-space: normal;">: <?php echo $judul; ?><span class="editable-area" id="client_info"><br />
																										</tr>
																									</tbody>
																								</table>
																							</div>
