...
$tahun_pajak = $_SESSION['thn_pjk'];
$pembetulan_ke = $_SESSION['pembetulan_ke'];
$status_hasil = $_SESSION['status_spt'];
...
Nama : '.$nama.'<br/>
NPWP : '.$npwp.'<br/>
Tahun Pajak : '.$tahun_pajak.'<br/>
Jenis SPT : 1771<br/>
Pembetulan ke : '.$pembetulan_ke.'<br/>
Status SPT : '.$status_hasil.'<br/>
...
header('location:spt_badan/lapor_1771.php?hasil=berhasil');
?>