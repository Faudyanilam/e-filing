      ...
      <div class="col-lg-5 col-md-8">
        <div class="form">
          ...
          <div class="form-group">
              <input type="text" name="npwp_user" class="form-control" id="npwp_user"   value=" <?php  echo $fetch_info_sql['NPWP']?>"readonly >
            </div>
            <div class="form-group mt-4">
              <input type="text" name="nama" class="form-control" id="nama"  value=" <?php if($fetch_info == NULL){}else{ echo $fetch_info['nama'];} ?>"readonly>
            </div>
            <div class="form-group mt-4">
              <textarea class="form-control" rows="4" name="alamat" id="alamat"  readonly><?php if($fetch_info == NULL){}else{  echo $fetch_info['alamat'];} ?></textarea>
            </div>
            <div class="form-group mt-4">
              <input type="text" class="form-control" name="telp" id="telp" placeholder="Masukkan No Telepon" value=" <?php  if($fetch_info == NULL){}else{echo $fetch_info['telp'];} ?>" readonly>
            </div>
            <div class="form-group mt-4">
                <input type="text" class="form-control" name="email_company" id="email_company" placeholder="Masukkan Email Perusahaan" value=" <?php if($fetch_info == NULL){}else{echo $fetch_info['email_company'];} ?>" readonly>
              </div>
              <div class="form-group mt-4">
                <input type="text" class="form-control" name="npwp_ttd" id="npwp_ttd" placeholder="Masukkan NPWP Penandatangan" value=" <?php if($fetch_info == NULL){}else{echo $fetch_info['npwp_ttd'];} ?>" readonly>
              </div>
              <div class="form-group mt-4">
                <input type="text" class="form-control" name="nama_ttd" id="nama_ttd" placeholder="Masukkkan Nama Penandatangan" value=" <?php if($fetch_info == NULL){}else{echo $fetch_info['nama_ttd'];}?>" readonly>
              </div>
              <div class="form-group mt-4">
                <input type="text" class="form-control" name="npwp_kuasa" id="npwp_kuasa" placeholder="Masukkan NPWP Kuasa" value=" <?php if($fetch_info == NULL){}else{ echo $fetch_info['npwp_kuasa'];}?>" readonly>
              </div>
              <div class="form-group mt-4">
                <input type="text" class="form-control" name="nama_kuasa" id="nama_kuasa" placeholder="Masukkan Nama Kuasa" value=" <?php if($fetch_info == NULL){}else{ echo $fetch_info['nama_kuasa'];}?>" readonly>
              </div>
              <div>
                <p><br><input type='checkbox' name='' >  Bendahara Pemerintah/Pembuat Bukti Potong A2</p>
              </div>
