...
<head>
    ...
    <!-- Title Page-->
    <title>DATA AKUN WP | POLITEKNIK NEGERI BATAM</title>
                            ...
                            <div class="table-responsive m-b-40">
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <h3 class="title-5 m-b-35">data Akun WP</h3>
                                    </div>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-striped table-bordered table-data2" id="dataTables">
                                        ...
                                        <tbody>
                                            ...
                                            include '../koneksi.php';
                                            $data = mysqli_query($koneksi,"select * from tb_registrasi_akun");
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td >
                                                        <div class="table-data-feature">
                                                            <a href="edit_akun.php?id=<?php echo base64_encode($row['id_regis']); ?>">
                                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="zmdi zmdi-edit"></i>
                                                                </button>
                                                            </a>
                                                            <a class="hapus" href="hapus_data_akun.php?id=<?php echo $row['id_regis']; ?>">
