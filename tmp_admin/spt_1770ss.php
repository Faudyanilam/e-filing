                        ...
                        <div class="col-lg-12" style="padding-left: 20%; padding-right: 20%">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="proses_tambah_1770ss.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div id="1770SSsatu" style="display: block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="pembetulan_ke" name="pembetulan_ke" value="0" min="0" class="form-control">
                                        ...
                                        <div id="1770SSdua" style="display: none">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="penghasilan_bruto" name="penghasilan_bruto" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="pengurangan" name="pengurangan" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="ptkp" name="ptkp" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="pkp" name="pkp" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="pp_terutang" name="pp_terutang" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="pp_dipotong" name="pp_dipotong" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="total" name="total" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                        ...
                                        <div id="1770SStiga" style="display: none">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="pp_final" name="pp_final" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="pp_final_terutang" name="pp_final_terutang" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="p_objek_pajak" name="p_objek_pajak" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                        ...
                                        <div id="1770SSempat" style="display: none">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="jml_harta" name="jml_harta" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="jml_kwj_utang" name="jml_kwj_utang" value="Rp. 0" class="uang form-control" style="text-align: right;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2" align="left">
                                                <button class="btn btn-warning btn-sm" id="back3" style="display: none" type="button">
