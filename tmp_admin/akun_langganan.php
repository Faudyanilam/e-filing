...
}else if ($_GET['hasil'] == "berhasil_ubah_password") {
    echo "<script>
    Swal.fire(
    'Password berhasil diubah menjadi',
    'taxcenter', 
    'success'
) </script>";
}else if ($_GET['hasil'] == "gagal_ubah_password") {
    echo "<script>
    Swal.fire(
                            ...
                            <div class="table-responsive m-b-40">
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <h3 class="title-5 m-b-35">Akun Langganan</h3>
                                    </div>
                                    ...
                                    <table class="table table-striped table-bordered table-data2" id="dataTables">
                                        <thead>
                                            <tr bgcolor="black" >
                                                ...
                                                <th style="color: white;">Awal</th>
                                                <th style="color: white;">Akhir</th>
                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysqli_fetch_array($data)){
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td class="desc"><?php echo $row['akun']; ?></td>
                                                    <td class="desc"><?php echo $row['id_daftar_npwp']; ?></td>
                                                    <td class="desc"><?php echo $row['nama_ktp']; ?></td>
                                                    <td class="desc"><?php echo $row['awal']; ?></td>
                                                    <td class="desc"><?php echo $row['akhir']; ?></td>
                                                    <td class="text-center">
                                                        <div class="table-data-feature">
                                                            <?php $test = base64_encode($row['id']); ?>
                                                            <a href="kirim_notif_email.php?id=<?php echo $test; ?>">
                                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Kirim Email Notifikasi">
                                                                    <i class="zmdi zmdi-email"></i>
                                                                </button>
                                                            </a>
                                                            &nbsp;&nbsp;
                                                            <a href="proses_ubah_password_langganan.php?id=<?php echo $row['id']; ?>">
                                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Ubah Password">
