                        ...
                        <div class="col-lg-12" style="padding-left: 20%; padding-right: 20%">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-lg-6" align="left">
                                            <strong>E-Registration</strong> | Add
                                        </div>
                                ...
                                <div class="card-body card-block">
                                    <form action="proses_tambah_eregis.php" method="post" 
                                    class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="id_daftar_npwp" placeholder="NPWP Wajib Pajak" class="form-control">
                                                <!-- <small class="help-block form-text">Please enter your email</small> -->
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label">EFFIN</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="efin" placeholder="EFFIN Wajib Pajak" class="form-control">
                                                <!-- <small class="help-block form-text">Please enter your email</small> -->
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="npwp" class="control-label mb-1">ID PAKET</label>
                                            </div>
                                            <div class="col-12 col-md-9">
