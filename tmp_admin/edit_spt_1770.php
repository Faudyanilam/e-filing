                        ...
                        <div class="col-lg-12" style="padding-left: 20%; padding-right: 20%">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <strong>SPT 1770</strong> | Edit
                                </div>
                                <div class="card-body card-block">
                                    <form action="proses_edit_1770.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <?php 
                                        include '../koneksi.php';
                                        $id = base64_decode($_GET['id']);
                                        $data = mysqli_query($koneksi,"select * from tb_upload_file_1770 where id='$id'");
                                            ...
                                            <div id="1770satu" style="display: block">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="npwp" name="npwp" placeholder="Nomor Pokok Wajib Pajak" class="form-control" value="<?php echo $row['id_spt_1770'];?>" readonly>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="file_spt" name="file_spt" accept=".csv, .xlsx" class="form-control" value="<?php echo $row['file_spt'];?>">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="file-input" class=" form-control-label">Lampiran 1</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="lampiran_1" name="lampiran_1" accept=".pdf" class="form-control" value="<?php echo $row['lampiran_1'];?>">
                                                        <!-- <small class="form-text text-muted"></small> -->
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="lampiran_2" name="lampiran_2" accept=".pdf" class="form-control" value="<?php echo $row['lampiran_2'];?>">
                                                        <!-- <small class="form-text text-muted"></small> -->
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="lampiran_3" name="lampiran_3" accept=".pdf" class="form-control" value="<?php echo $row['lampiran_3'];?>">
                                                        <!-- <small class="form-text text-muted"></small> -->
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="lampiran_4" name="lampiran_4" accept=".pdf" class="form-control" value="<?php echo $row['lampiran_4'];?>">
                                                        <!-- <small class="form-text text-muted"></small> -->
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        ...
                                        <div id="1770dua" style="display: none">
                                            ...
                                            include '../koneksi.php';
                                            $id = base64_decode($_GET['id']);
                                            $data = mysqli_query($koneksi,"select * from tb_hasil_lapor_1770 where id='$id'");
                                            while($row = mysqli_fetch_array($data)){
                                                ?>
                                                <div class="row form-group">
