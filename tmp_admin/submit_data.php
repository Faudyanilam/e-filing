                        ...
                        <div class="col-lg-12" style="padding-left: 20%; padding-right: 20%">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6" align="left">
                                            <strong>Kirim Email</strong> | Pelanggan
                                        </div>
                                ...
                                <div class="card-body card-block">
                                    ...
                                    $data = mysqli_query($koneksi,"select * from tb_pelanggan where id='$id'");
                                    while($row = mysqli_fetch_array($data)){
                                        ?>
                                        <form action="proses_submit_data.php" method="post" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">NPWP</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="npwp" class="npwp form-control" value="<?php echo $row['id_daftar_npwp']?>" readonly>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="email" name="nama_email" class="form-control" value="<?php echo $row['email']?>" readonly>
