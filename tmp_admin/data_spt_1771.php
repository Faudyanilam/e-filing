...
<head>
    ...
    <!-- Title Page-->
    <title>DATA SPT 1771 | POLITEKNIK NEGERI BATAM</title>
                            ...
                            <div class="table-responsive m-b-40">
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <h3 class="title-5 m-b-35">data SPT 1771</h3>
                                    </div>
                                    ...
                                    <table class="table table-striped table-bordered table-data2" id="dataTables">
                                        <thead>
                                            <tr bgcolor="black" >
                                                ...
                                                <th style="color: white;">lampiran</th>
                                        ...
                                        <tbody>
                                            ...
                                            $data = mysqli_query($koneksi,"select * from tb_spt_1771 inner join tb_upload_file_1771 on tb_spt_1771.npwp = tb_upload_file_1771.id_spt_1771 inner join tb_hasil_lapor_1771 on tb_spt_1771.npwp = tb_hasil_lapor_1771.id_spt_1771 where tb_upload_file_1771.id = tb_hasil_lapor_1771.id");
                                            ...
                                            while($row = mysqli_fetch_array($data)){
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td>
                                                        <a style="color: blue;" href="../spt_badan/csv_pdf/<?php echo $row['file_spt_1771'] ?>"><?= $row['file_spt_1771']?></a>
                                                    </td>
                                                    <td class="desc">
                                                        <a style="color: blue;" href="../spt_badan/csv_pdf/<?php echo $row['lampiran_keuangan']; ?>"><?= $row['lampiran_keuangan']?></a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <a href="edit_spt_1771.php?id=<?php echo base64_encode($row['id']); ?>">
                                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="zmdi zmdi-edit"></i>
                                                                </button>
                                                            </a>
                                                            <a class="hapus" href="hapus_data_1771.php?id=<?php echo $row['id'] ?>">
