                        ...
                        <div class="col-lg-12" style="padding-left: 20%; padding-right: 20%">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="proses_tambah_1771.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select class="form-control-sm form-control" name="npwp" id="npwp" onchange='changeValue(this.value)'>
                                                        ...
                                                        $sql=mysqli_query($koneksi, "SELECT * FROM tb_registrasi_akun INNER JOIN tb_daftarnpwp ON tb_registrasi_akun.npwp = tb_daftarnpwp.id_daftar_npwp where tb_daftarnpwp.jenis_wp = 'Badan'");
                                        ...
                                        <div id="1771dua" style="display: none">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <input type="text" id="jumlah" name="jumlah" value="Rp. 0" placeholder="Jumlah SPT Wajib Pajak" class="uang form-control text-right">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-4">
