...
<body class="bg-body">
	...
	if(isset($_POST['upload2'])){
		$file_spt_1770 = $_FILES['file']['name'];
		...
		$_SESSION['file_spt_1770'] = $file_spt_1770;
		$_SESSION['lampiran_1'] = $lampiran_1;
		$_SESSION['lampiran_2'] = $lampiran_2;
		$_SESSION['lampiran_3'] = $lampiran_3;
		$_SESSION['lampiran_4'] = $lampiran_4;
	}
	?>
	<!-- end TAMPUNG -->
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (isset($_POST['kode_verif_1770'])) {
			if ($_SESSION['kode_verif']!=$_POST['kode_verif_1770']){
				...
				header('location:../berhasil_lapor_70.php?hasil=berhasil');
							...
							<div class="card bg-light mb-3" style="width:735px; background-color: white;">
								...
								<div class="card-body card-body_2">  
									...
									<div class='form-group row'>
										...
										<div class='col-sm-6' style='padding-right: 50px'>
											<input class='form-control' name='kode_verif_1770' id='' value='' required disabled>
											<?php echo $pesan; ?>
										</div>
									...
									<div align='center'>
										<a href="../lapor_1770.php">
											<button type='submit' class='btn btn-secondary' name='import' style='background-color: rgb(4, 153, 195); border-radius: 25px; color: white;' data-dismiss='modal' disabled><i class='fas fa-paper-plane'></i> Kirim SPT</button>
										</a>
									...
									<!-- Modal Verifikasi -->
									<form action="proses_kode_verif.php" method="post">
