...
<body style="background-image:  url('img/poltek3.jpeg'); background-size:cover;">
    ...
    Swal.fire(
    'Suspended',
    'Akun telah melewati batas trial, silahkan hubungi admin.',
    'warning'
) </script>"; 
}
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['input_kode'])) {
        if ($_SESSION['kode_captcha']!=$_POST['input_kode']){
            ...
            include 'proses_login_badan.php';
        }
    }
}
?>
...
//   END buat lihat sandi Javascript
    ...
    function perbaiki_npwp(){
        ...
        // satukan hasil potongan
        if (npwp != ""){
            hasil_perbaikan_npwp = " NPWP : " + s1 + "." + s2 + "." + s3 + "." + s4 + "-" + s5 + "." + s6;
        }else if (npwp < 2){
            hasil_perbaikan_npwp = "NPWP : ";
        }
        
        // tampilkan hasil potongan
        document.getElementById('fixed_npwp').innerHTML = hasil_perbaikan_npwp;
    }
</script>
