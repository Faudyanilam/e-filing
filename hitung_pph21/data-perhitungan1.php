      ...
      <div class="row">
        ...
        <div class="section-title-divider"></div>
            ...
            <div class="col-12">
             ...
             <?php
            include "koneksi.php";
            $query = mysqli_query($koneksi,"SELECT * FROM perhitungan1 ");
        ...
        <tr>
            ...
            <td><?php echo $data["npwp1"];?></td>
            <td><?php echo $data["nama1"];?></td>
            <td><?php echo $data["masa1"];?></td>
            <td><?php echo $data["gaji_pensi1"];?></td>
            <td><?php echo $data["hasil_18"];?></td>
            <td><?php echo $data["biaya_jbtn1"];?></td>
            <td><?php echo $data["hasil_910"];?></td>
            <td><?php echo $data["neto1"];?></td>
            <td><?php echo $data["neto_setahun1"];?></td>
            <td><?php echo $data["penghasilan_tdk_pjk1"];?></td>
            <td><?php echo $data["penghasilan_kena_pjk1"];?></td>
            <td><?php echo $data["penghasilan_kena_pjk_setahun1"];?></td>
            <td><?php echo $data["pph21_dipotong_sebelum1"];?></td>

             <td>
  
                <button class="btn btn-danger"><a href="delete2.php?no1=<?php echo $data['no1']; ?>">DELETE</a></button>
            </td>
