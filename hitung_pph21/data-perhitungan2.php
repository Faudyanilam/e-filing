      ...
      <div class="row">
        ...
        <div class="section-title-divider"></div>
            ...
            <div class="col-12">
             ...
             <?php
            include "koneksi.php";
            $query = mysqli_query($koneksi,"SELECT * FROM perhitungan2 ");
        ...
        <tr>
            ...
            <td><?php echo $data["npwp2"];?></td>
            <td><?php echo $data["nama2"];?></td>
            <td><?php echo $data["masa2"];?></td>
            <td><?php echo $data["gaji_pensi2"];?></td>
            <td><?php echo $data["hasil_18_2"];?></td>
            <td><?php echo $data["biaya_jbtn2"];?></td>
            <td><?php echo $data["hasil_910_2"];?></td>
            <td><?php echo $data["neto_2"];?></td>
            <td><?php echo $data["neto_setahun_2"];?></td>
            <td><?php echo $data["penghasilan_tdk_pjk2"];?></td>
            <td><?php echo $data["penghasilan_kena_pjk2"];?></td>
            <td><?php echo $data["penghasilan_kena_pjk_setahun2"];?></td>
            <td><?php echo $data["pph21_dipotong_sebelum2"];?></td>

             <td>
  
                <button class="btn btn-danger"><a href="delete3.php?no2=<?php echo $data['no2']; ?>">DELETE</a></button>
            </td>
