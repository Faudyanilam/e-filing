...
$input=mysqli_query($koneksi,"INSERT INTO `perhitungan1`( npwp1, nama1, masa1, gaji_pensi1, hasil_18, biaya_jbtn1, hasil_910, neto1, neto_setahun1, penghasilan_tdk_pjk1, penghasilan_kena_pjk1, penghasilan_kena_pjk_setahun1, pph21_dipotong_sebelum1) 
...
if ($input) {
	...
	header("location:data-perhitungan1.php");
	}else{
	echo "Gagal Disimpan";
}
