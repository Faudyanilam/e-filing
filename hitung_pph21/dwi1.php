                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><b>Masukkan Status Pegawai yang Bekerja Tidak Setahun Penuh</b></h5> 
                            </div>
                        <div class="modal-body">

                            <td>
                                <input type="radio" onclick="window.location='perhitungan.php';"></a>
                                Dipindahkan Ke Kantor Pusat atau Kantor Cabang lainnya dengan Pemberi kerja yang sama
                            <br>
                                <input type="radio" onclick="window.location='perhitungan2.php';"></a>
                                Berhenti namun tidak meninggalkan indonesia
                            <br>
                            ...
                            <br>
                                <input type="radio" onclick="window.location='perhitungan2.php';"></a>
                                Pindahan Ke Kantor Pusat atau Kantor Cabang lainnya dengan Pemberi kerja yang sama
                            <br>
                                &nbsp;&nbsp;&nbsp;Pegawai baru pindahan dari pemberi kerja lain
                            <br>
                                &nbsp;&nbsp;&nbsp;Pegawai baru saja pensiun 
               ...
               <!-- akhir Modal -->
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-md-10">
                        <div class="form">
                            <form name="form3" id="form3" action="" method="post" role="form" class="php-email-form">
                                <div class="form-group ">
                                    <table >
                                        <td>
                                            <input type="text" class="form-control" name="subject" id="npwp" placeholder="Masukkan NPWP"
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control" name="subject" id="nama" placeholder="Masukkan Nama" required>
                                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-8">
                        <div class="form">
                            <form id="formD" name="formD" action="proses-perhitungan.php" method="post" role="form" class="php-email-form" enctype="multipart/form-data">
                                <div class="form-group ">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control" name="tunjangan_pph" id="tunjangan_pph" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>

                                </div>
                                <div class="form-group mt-3">

                                        <input type="text" class="form-control" name="tunjangan_lain" id="tunjangan_lain" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)"  required>

                                </div>
                                <div class="form-group mt-3">

                                        <input type="text" class="form-control" name="honor" id="honor" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
                                </div>
                                <div class="form-group mt-3">

                                        <input type="text" class="form-control" name="premi_asuransi" id="premi_asuransi" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
                                </div>
                                <div class="form-group mt-4">

                                        <input type="text" class="form-control" name="penerima_bntuk_natura" id="penerima_bntuk_natura" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
                                </div>
                                <div class="form-group mt-4">

                                        <input type="text" class="form-control" name="bonus" id="bonus" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
                                </div>
                                <div class="form-group mt-4">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <br>
                                        ...
                                        <input type="text" class="form-control" name="biaya_jbtn" id="biaya_jbtn" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" readonly="readonly" required>
                                </div>
                                <div class="form-group mt-3">

                                        <input type="text" class="form-control" name="iuran_pensi" id="iuran_pensi" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
                                </div>
                                <div class="form-group mt-3">
...
<br>
    ...
    <script>
        ...
        var hasil_1_8 = document.getElementById('hasil_1_8');
            hasil_1_8.addEventListener('keyup', function(e)
        {
            hasil_1_8.value = formatRupiah(this.value);
        });
      ...
      //var b1 ke 2
        ...
        function OnChange(value){
          ...
          if (biayajabatan > 500000){
            ...
            document.formD.biaya_jbtn.value = biayajabatan;
        }else{
        ...
        if (total6 > 500000000 ){
         ...
         total8 = total7 - ((total7/12) * hasil2);
          ...
          document.formD.pph21_dipotong_sebelum.value = pph21dipotong;
