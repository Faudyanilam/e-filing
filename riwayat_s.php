						...
						<div class="panel-body">
							...
							<div class="card bg-light mb-3" style="width:735px; background-color: white;">
								...
								<div class="card-header card-header_1">
									...
									<b>Hasil Jawaban Pelaporan SPT 1770 S</b>
								...
								<div class="card-body card-body_2">  
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											$data = mysqli_query($koneksi,"select id from tb_bukti_potong_s where id_spt_1770s = '$npwp'");

											$cek = mysqli_fetch_assoc($data) ['id'];


											$data = mysqli_query($koneksi,"select * from tb_bukti_potong_s where id = '$cek'");
											...
											if($tahun_pajak == $tahunpajak){
												...
												echo "<strong><p style='color:black'>".$tahunpajak."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($statusspt, $status_spt) == 0){
												...
												echo "<strong><p style='color:black'>".$statusspt."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($pembetulan_ke == $pembetulanke){
												...
												echo "<strong><p style='color:black'>".$pembetulanke."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($jenispajak, $jenis_pajak) == 0){
												...
												echo "<strong><p style='color:black'>".$jenispajak."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($npwp_pemotong == $npwppemotong){
												...
												echo "<strong><p style='color:black'>".$npwppemotong."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											// $nama_pemotongg = $_SESSION['tmpnama_pemotong'];
											// echo $nama_pemotongg;
											...
											$cek = mysqli_fetch_assoc($data);
											// mengubah nama harta didatabase
											$nama_pemotongg = $cek['nama_pemotong'];

												// session nama harta = harta di database
											if(strcasecmp($nama_pemotong, $nama_pemotongg) == 0){
												
												echo "<strong><p style='color:black'>".$nama_pemotongg."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($nomor_bukti == $nomorbukti){
												...
												echo "<strong><p style='color:black'>".$nomorbukti."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($tanggal_bukti == $tanggalbukti){
												...
												echo "<strong><p style='color:black'>".$tanggalbukti."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											echo "<tr>";
											echo "<td>".end($tmpjumlah_pph)."</td></tr>";
											$jml_pph = end($tmpjumlah_pph);
										...
										<div class="col-sm-3">
											...
											$cek = mysqli_fetch_assoc($data);
											// mengubah nama harta didatabase
											$jumlah_pph = $cek['jumlah_pph'];
											// var_dump($nama_harta);
											// $nama_harta = $data['nama_harta'];

												// session nama harta = harta di database
											if($jml_pph == $jumlah_pph){
												
												echo "<strong><p style='color:black'>".$jumlah_pph."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($neto_dn == $neto_dlm_negeri){
												...
												echo "<strong><p style='color:black'>".$neto_dlm_negeri."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											// mengambil data dari database
											$data = mysqli_query($koneksi,"select id from tb_non_bukti_potong_s where id_spt_1770s = '$npwp'");

											$cek = mysqli_fetch_assoc($data) ['id'];


											$data = mysqli_query($koneksi,"select * from tb_non_bukti_potong_s where id = '$cek'");
											$cek = mysqli_fetch_assoc($data);
											// mengubah nama harta didatabase
											$bungaa = $cek['bunga'];
											// var_dump($nama_harta);
											...
											if($bunga == $bungaa){
												...
												echo "<strong><p style='color:black'>".$bungaa."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($royalti == $royaltii){
												...
												echo "<strong><p style='color:black'>".$royaltii."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($sewa == $sewaa){
												...
												echo "<strong><p style='color:black'>".$sewaa."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($hadiah == $hadiahh){
												...
												echo "<strong><p style='color:black'>".$hadiahh."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($keuntungan == $keuntungann){
												...
												echo "<strong><p style='color:black'>".$keuntungann."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($p_lain == $penghasilan_lain){
												...
												echo "<strong><p style='color:black'>".$penghasilan_lain."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($luar_negeri == $luarnegeri){
												...
												echo "<strong><p style='color:black'>".$luarnegeri."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($sumbangan == $sumbangann){
												...
												echo "<strong><p style='color:black'>".$sumbangann."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($warisan == $warisann){
												...
												echo "<strong><p style='color:black'>".$warisann."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($laba_perseroan == $labaperseroan){
												...
												echo "<strong><p style='color:black'>".$labaperseroan."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($asuransi == $asuransii){
												...
												echo "<strong><p style='color:black'>".$asuransii."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($beasiswa == $beasiswaa){
												...
												echo "<strong><p style='color:black'>".$beasiswaa."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($penghasilan_lain_tob == $p_lain_tob){
												...
												echo "<strong><p style='color:black'>".$p_lain_tob."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($sumber_penghasilan, $sumberpenghasilan) == 0){
												...
												echo "<strong><p style='color:black'>".$sumberpenghasilan."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($dpp == $dpp1){
												...
												echo "<strong><p style='color:black'>".$dpp1."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($pph_terutang == $pphterutang){
												...
												echo "<strong><p style='color:black'>".$pphterutang."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($kode_harta == $kodeharta){
												...
												echo "<strong><p style='color:black'>".$kodeharta."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($namaharta, $nama_harta) == 0){
												...
												echo "<strong><p style='color:black'>".$namaharta."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($tahun_perolehan == $tahunperolehan){
												...
												echo "<strong><p style='color:black'>".$tahunperolehan."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($harga_perolehan == $hargaperolehan){
												...
												echo "<strong><p style='color:black'>".$hargaperolehan."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($keterangan1, $keterangan) == 0 ){
												...
												echo "<strong><p style='color:black'>".$keterangan1."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($kode_utang == $kodeutang){
												...
												echo "<strong><p style='color:black'>".$kodeutang."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($nama_pemberi_pinjaman, $nama_pemberipinjaman) == 0){
												...
												echo "<strong><p style='color:black'>".$nama_pemberipinjaman."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($alamat_pemberi_pinjaman, $alamat_pemberipinjaman) == 0){
												...
												echo "<strong><p style='color:black'>".$alamat_pemberipinjaman."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($tahun_peminjaman == $tahunpeminjaman){
												...
												echo "<strong><p style='color:black'>".$tahunpeminjaman."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($jumlah_utang == $jumlahutang){
												...
												echo "<strong><p style='color:black'>".$jumlahutang."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($nama_keluarga, $namakeluarga) == 0){
												...
												echo "<strong><p style='color:black'>".$namakeluarga."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($nik_keluarga == $nikkeluarga){
												...
												echo "<strong><p style='color:black'>".$nikkeluarga."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($hubungan_keluarga, $hubungankeluarga) == 0){
												...
												echo "<strong><p style='color:black'>".$hubungankeluarga."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											// mengubah nama harta didatabase
											$pekerjaankeluarga = $cek['pekerjaan'];
											// var_dump($nama_harta);
											// $nama_harta = $data['nama_harta'];
											...
											if(strcasecmp($pekerjaan_keluarga, $pekerjaankeluarga) == 0){
												...
												echo "<strong><p style='color:black'>".$pekerjaankeluarga."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($zakat_sumbangan == $zakatsumbangan){
												...
												echo "<strong><p style='color:black'>".$zakatsumbangan."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($status_perkawinan, $statusperkawinan) == 0){
												...
												echo "<strong><p style='color:black'>".$statusperkawinan."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($status_pjk, $statuspjk) == 0){
												...
												echo "<strong><p style='color:black'>".$statuspjk."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($npwp_istri_suami == $npwp_si){
												...
												echo "<strong><p style='color:black'>".$npwp_si."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($ptkp, $ptkp1) == 0){
												...
												echo "<strong><p style='color:black'>".$ptkp1."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($jumlah_tanggungan == $jumlahtanggungan){
												...
												echo "<strong><p style='color:black'>".$jumlahtanggungan."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if(strcasecmp($lapor_sebagai, $laporsebagai) == 0){
												...
												echo "<strong><p style='color:black'>".$laporsebagai."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($neto_suami == $netosuami){
												...
												echo "<strong><p style='color:black'>".$netosuami."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($neto_istri == $netoistri){
												...
												echo "<strong><p style='color:black'>".$netoistri."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($pengurangan_pph21 == $penguranganpph21){
												...
												echo "<strong><p style='color:black'>".$penguranganpph21."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($pembayaran_pph25 == $pembayaranpph25){
												...
												echo "<strong><p style='color:black'>".$pembayaranpph25."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($pembayaran_stp_pph25 == $pembayaran_stppph25){
												...
												echo "<strong><p style='color:black'>".$pembayaran_stppph25."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($hasil_pengurangan_neto_zakat == $neto_zakat){
												...
												echo "<strong><p style='color:black'>".$neto_zakat."</p></strong>";
									...
									<div class="row">
										<div class="col-sm-4">
											<p><strong>Penghasilan Tidak Kena Paj ak/Jumlah Tanggungan</strong></p>
										</div>
										...
										<div class="col-sm-3">
											...
											if($ptkp_jml_tanggungan == $ptkp_tanggungan){
												...
												echo "<strong><p style='color:black'>".$ptkp_tanggungan."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($pkp == $pkp1){
												...
												echo "<strong><p style='color:black'>".$pkp1."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											echo "<tr>";
											echo "<td>".end($tmppph_terutang_tarif)."</td></tr>";
										...
										<div class="col-sm-3">
											...
											if($pph_terutang_tarif == $pph_tarif){
												...
												echo "<strong><p style='color:black'>".$pph_tarif."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											echo "<tr>";
											echo "<td>".end($tmpjumlah_pph_terutang)."</td></tr>";
										...
										<div class="col-sm-3">
											...
											if($jumlah_pph_terutang == $jmlpph_terutang){
												...
												echo "<strong><p style='color:black'>".$jmlpph_terutang."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											// mengubah nama harta didatabase
											$pph_dipotong_lain = $cek['pph_dipotong'];
											// var_dump($nama_harta);
											// $nama_harta = $data['nama_harta'];
											...
											if($pph_dipotong_pihak_lain == $pph_dipotong_lain){
												...
												echo "<strong><p style='color:black'>".$pph_dipotong_lain."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($pph_dibayar_sendiri == $pphbayar_sendiri){
												...
												echo "<strong><p style='color:black'>".$pphbayar_sendiri."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($jumlah_kredit == $jmlkredit){
												...
												echo "<strong><p style='color:black'>".$jmlkredit."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($status_hasil_s == $statushasil){
												...
												echo "<strong><p style='color:black'>".$statushasil."</p></strong>";
									...
									<div class="row">
										...
										<div class="col-sm-3">
											...
											if($jumlah_hasil_akhir == $jml_hasilakhir){
												...
												echo "<strong><p style='color:black'>".$jml_hasilakhir."</p></strong>";
