...
<body class="bg-body">
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (isset($_POST['kode_verif_1771'])) {
			...
			if ($_SESSION['kode_verif']!=$_POST['kode_verif_1771']){
				...
				header('location:lapor_1771.php?hasil=berhasil');
								...
								<div class="card-body card-body_2">  
									...
									<div class='form-group row'>
										...
										<div class='col-sm-6' style='padding-right: 50px'>
											...
											<input class='form-control' name='kode_verif_1771' id="kode_verif" required>

											<!-- <input class='form-control' name='' id="kode_verif2" style="display: none;"> -->
									...
									<div align='center'>
										...
										<a href="lapor_1771.php">

											<button type='submit' class='btn btn-secondary' name='import' style='background-color: rgb(4, 153, 195); border-radius: 25px; color: white;'><i class='fas fa-paper-plane'></i> Kirim SPT</button>
									...
									<form action="../kode_verif_1771.php" method="post">
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<div class="custom-control custom-radio">
															...
															<input class="form-control" type="text" name="nama_email" placeholder="Masukkan Email Anda" style="width: auto;" required>
