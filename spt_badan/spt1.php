...
<body class="bg-body">
	...
	if(isset($_POST['ups'])){
		...
		$_SESSION['lampiran_1771'] = $lampiran_1771;
	}
	?>
							...
							<div class="card bg-light mb-3" style="width:735px; background-color: white;">
								...
								<div class="form-group row" style="padding-left: 20%; padding-right: 15%; padding-top: 5px">
									...
									<div class="col-sm-5">
										...
										<input oninput="showname()" class='form-control' name='' id="kode_verif" disabled>
	...
	function showname () {
		...
		if($kode_verif == ""){
			document.getElementById('ups').style.backgroundColor = "blue";
		}else{
