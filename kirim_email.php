...
Terimakasih telah melakukan Pembayaran silahkan melakukan pendaftraan akun di website https://taxcenter-polibatam.id/<br/><br/>
...
$mail->Subject ="Pembayaran Telah Di Konfirmasi";
...
header('location:tmp_admin/data_langganan.php');
