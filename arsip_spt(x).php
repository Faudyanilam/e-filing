		...
		<form>
			...
			<!-- <ul class="nav nav-tabs">
				<li class="nav-item" style="background-color: #f5f5f5; ">
					<a href="arsip_spt.php" style="color: #191970;" active>Arsip SPT</a>
				</li>
				<li class="nav-item" >
					...
					<div class="panel panel-default" >
						...
						<div class="panel-body">
							...
							<div class="col-sm-6 col-md-8">
								<!-- card kanan -->
								<div class="card bg-light mb-3 card_2" style="width: 600px">
									...
									<div class="card-body card-body_2">  
										...
										<div class="table" style="padding-top: 15px;">
											<table class="table table_2" style="border: 1px solid #ccc; box-shadow: 1px 5px 8px rgba(0,0,0,0.4);">
